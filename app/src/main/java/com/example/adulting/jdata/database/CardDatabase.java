...
public abstract class CardDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected  Void doInBackground(Void... voids) {
            ...
            cardInfoDAO.insert(new CardInfo(2, "College Choice", "You can go to a smaller private school for more money and a personalized education. Or go to a bigger public univeristy where you are unsure whether you will succeed in a large lecture hall, but you also save money."));
            cardInfoDAO.insert(new CardInfo(3, "Hernia", "You notice a bulge in your abdomen after doing some lifting around the house."));
            cardInfoDAO.insert(new CardInfo(3, "Tooth Problem", "You have major tooth pain and should see the dentist, but you are unsure if you can afford, it if it’s even worth going."));
            ...
            cardInfoDAO.insert(new CardInfo(3, "Where to Eat?", "You can save money and eat at McDonald's or spend a little bit more and eat a Chick-Fil-A salad and eat healthier"));
            cardInfoDAO.insert(new CardInfo(3, "Snack?", "You want a snack and your options are cookies and berries"));
            cardInfoDAO.insert(new CardInfo(4, "Phish?", "Nigerian Prince offers you inheritance to $100,000,000 estate if you send him a processing fee of $100 via Western Union."));
            cardInfoDAO.insert(new CardInfo(4, "Lottery", "You have a strong hunch that this week you know the winning numbers."));
            cardInfoDAO.insert(new CardInfo(4, "Penny Stocks", "Your brothers friends uncles cousin has a startup company for a new fuel source, he invites you to become one of the first investors."));
            cardInfoDAO.insert(new CardInfo(4, "Jacket Purchase", "You need a new winter coat, you can be cold and buy a cheap or buy a warmer more expensive one. if you go with the cheaper one you're more likely of getting sick through out the winter."));
            ...
            responseDAO.insert(new Response(3,"Reschedule honeymoon because you are absolutely flooded at work.",false,0,0,0,0,-10,0,0,5));
            responseDAO.insert(new Response(3,"As an extra surprise you tell your wife you are actually staying for 2 weeks.",true,30,0,0,0,15,0,10,-5));
            ...
            responseDAO.insert(new Response(13,"Go to the doctor immediately.",false,0,0,0,0,0,0,5,5));
            ...
            responseDAO.insert(new Response(16,"Find the cheapest thing at Chick-Fil-A.",true,0,0,0,10,0,0,5,5));
            ...
            responseDAO.insert(new Response(22,"Buy a membership.",false,0,0,0,0,0,0,15,-10));
